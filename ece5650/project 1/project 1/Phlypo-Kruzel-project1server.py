...
# Explanation: In case of command Search/Remove, customerID is used. Our program was unable to find this therefore,
# outputs no record when the record does exist. Otherwise, program runs correctly
